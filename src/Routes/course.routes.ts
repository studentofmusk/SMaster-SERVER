...
import { add_group, add_lesson, add_season, add_topic, create_group, create_language, create_lecture, create_lesson, create_season, create_t2action, create_t2video, create_v2action, create_v2text, create_video, get_groups, get_languages, get_lectures, get_lessons, get_seasons, get_t2action, get_t2video, get_v2action, get_v2text, get_videos } from "../Controllers/course.controller.js";
